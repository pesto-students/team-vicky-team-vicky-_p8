...
import { ToastError, ToastSucess, ToastWarning } from "../utils/Toast";
  ...
  useEffect(() => {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      switch (paymentIntent.status) {
        case "succeeded":
          ToastSucess("Payment succeeded!");
          setMessage("Payment succeeded!");
          break;
        case "processing":
          ToastWarning("Your payment is processing.");
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await stripe.confirmPayment({
      ...
      confirmParams: {
        ...
        return_url: "https://team-vicky-team-vicky-p8.vercel.app/success",
      },
    });
